...
<c:forEach var="vo" items="${list}">  
            <div class="thumbnail col-sm-3 col-md-3.5" style="margin-bottom: 5px; border: 1px solid #ddd" onmouseout="change2(this)" onmouseover="change1(this)"> 
			...
			<div class="modal fade bs-example-modal-lg bs-example-modal-lg" id="my${vo.board_tno }" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			  ...
			  </div>thumbnail col-sm-3 col-md-3.5
			</div>
</c:forEach>
         </div>
        </div>
